...
from stock.views import StockProductViewsets, show_reports_sf, show_reports_sr, StockOutProductViewsets, show_reports_rp, StockProductSFViewsets, StockProductSRViewsets, ProductViewsets, CasesPaluViewsets
