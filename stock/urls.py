...
from stock.views import (
    StockProductSFViewsets,
    cas_palu,
    situation_stock,
    StockOutProductViewsets,
    show_reports_rp,
    ProductViewsets,
    CasesPaluViewsets,
    RateViewsets,
    CasesPaluProvViewsets,
    CasesPaluDisViewsets,
    CasesPaluCdsViewsets,
    StockProductProvViewsets,
    StockProductDisViewsets,
    StockProductCDSViewsets,
    ReportCAViewsets,
    ReportSTViewsets,
    CasesPaluExport,
    StockProductExport,
